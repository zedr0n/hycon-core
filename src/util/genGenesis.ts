...
configure({
	appenders: {
		...
		fileLogs: {
			filename: `./logs/${new Date().getFullYear()}-${new Date().getMonth() +
				1}-${new Date().getDate()}/logFile.log`,
			keepFileExt: true,
			maxLogSize: 16777216,
			pattern: ".yyyy-MM-dd",
			type: "dateFile",
...
const nameList = [
	{ name: "ico", balance: 2e9 },
	{ name: "airdrop", balance: 4e8 },
	{ name: "team", balance: 5e8 },
	{ name: "devfund", balance: 5e8 },
	{ name: "bounty", balance: 5e8 },
	{ name: "csr", balance: 1e8 },
	// Just for testGenesis
	{ name: "test1", balance: 1e6 },
	{ name: "test2", balance: 2e6 },
	{ name: "test3", balance: 3e6 },
	{ name: "test4", balance: 4e6 },
	{ name: "test5", balance: 5e6 },
	{ name: "test6", balance: 6e6 },
	{ name: "test7", balance: 7e6 },
	{ name: "test8", balance: 8e6 },
	{ name: "test9", balance: 9e6 },
	{ name: "test10", balance: 1e7 },
	{ name: "test11", balance: 11e6 },
	{ name: "test12", balance: 12e6 },
]
